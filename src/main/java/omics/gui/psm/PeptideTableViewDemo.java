...
public class PeptideTableViewDemo extends Application
{
    ...
    public void start(Stage primaryStage)
    {
        ...
        PeptideTableView tableView = new PeptideTableView(spectrum, deltaMap, "Da");
//        tableView.setPrefHeight(550);

        VBox root = new VBox();
//        root.setPrefWidth(tableView.getPrefWidth());
...
//        ScenicView.show(scene);
        ...
        primaryStage.setTitle("Peptide Table");
        primaryStage.setScene(scene);
        primaryStage.show();

//        System.out.println();
//        for (TableColumn<Map, ?> mapTableColumn : tableView.getColumns()) {
//            System.out.println(mapTableColumn.getWidth());
//        }
