...
//        MsDataFile dataFile = MsDataFile.read("Z:\\MaoJiawei\\data\\liujing\\20200520_S1_CG_Glycopeptides_1ug_HCD-1
//        .mgf");
//        MsDataFile dataFile = MsDataFile.read
//        ("Z:\\MaoJiawei\\data\\liujing\\20200520_S1_CG_Glycopeptides_1ug_193nmUVPD_1_5mJ-1.mgf");
...
//        MsnSpectrum spectrum = map.get(String.valueOf(scan));
        ...
        PeptideFragmenter fragmenter = PeptideFragmenter.getInstance(ions);
        PeptideSpectrum spectrum = fragmenter.fragment(peptide, 1);
...
//        IonAnnotator.annotatePrecursor(msnSpectrum, ms2, 1, Integer.MAX_VALUE);
        ...
        root.setPeptideSpectrum(peptide, (PeakList) spectrum);
